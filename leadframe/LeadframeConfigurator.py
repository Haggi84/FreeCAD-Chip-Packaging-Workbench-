...
class LeadframeConfigurator(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.lead_width.setSingleStep(0.01)
        self.lead_width.setSuffix(" mm")
        self.lead_width.setValue(0.25)
        ...
        qfn_qfp_layout.addRow("Pad Thickness:", self.qfn_pad_thickness)
